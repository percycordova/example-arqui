...
import { TableQualification } from '../../components/tables/tableQualification/TableQualification';

const PageProcessQualification = () => {
  ...
  return (
    <div className="min-h-screen bg-white mb-10">
      <div className="mx-auto max-w-7xl px-4 py-6">
        <Title text="CALIFICACION Y ASIGNACION DE PROCESOS" />
...
export const Component = PageProcessQualification;
