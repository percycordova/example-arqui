...
export const ButtonBase = ({
  ...
  const base =
    'inline-flex cursor-pointer items-center justify-center px-4 py-2 rounded-lg font-medium shadow-sm text-sm transition-all duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-1';
